  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-full shrink-0">
      ...
      <div className="flex-1 py-6 overflow-y-auto">
        ...
        <SidebarItem href="/logistics" icon={
        ...
        <SidebarItem href="/logistics/products" icon={
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <SidebarItem href="/logistics/supplies" icon={
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <SidebarItem href="/logistics/inventory" icon={
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <SidebarItem href="/logistics/orders" icon={
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <SidebarItem href="/logistics/inbound" icon={
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <SidebarItem href="/logistics/coupang" icon={
          <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
